        ...
        Dim items = Await Task.Run(Async Function()
                                       ...
                                       Try
                                           ...
                                           For Each elm In elements
                                               ...
                                               Dim name = elm.FindElement(By.CssSelector("div.x9f619.x1ja2u2z.x78zum5.x1n2onr6.x1iyjqo2.xs83m0k.xeuugli.x1qughib.x6s0dn4.x1a02dak.x1q0g3np.xdl72j9 > div > div > div > div:nth-child(1) > span > span > span")).GetAttribute("innerHTML")
                                               Dim url = elm.GetAttribute("href")
                                               Dim item As New ListViewItem(name)
                                               item.SubItems.Add(url)
                                               itemList.Add(item)
                                       ...
                                       Try
                                           ...
                                           Select Case messageSource
                                               Case "聊天室"
                                                   ...
                                                   contentSpanCssSelector = "span.html-span.xdj266r.x14z9mp.xat24cr.x1lziwak.xexx8yu.x18d9i69.x1c1uobl.x1hl2dhg.x16tdsg8.x1vvkbs.x6s0dn4.x9f619.x78zum5.x193iq5w.x14vy60q.xeuugli > span > span"
                                               Case "Marketplace"
        ...
        Try
            Await Task.Run(Async Function()
                               Try
                                   ...
                                   Dim unread_dot_CssSelector = "a > div.x1qjc9v5.x9f619.x78zum5.xdl72j9.xdt5ytf.x2lwn1j.xeuugli.x1n2onr6.x1ja2u2z.x1es9f29.xn45owk.x1vu7fv8.x1rcwl9y.x1iyjqo2.xs83m0k > div > div > div:nth-child(3) > div > div > div > div > span"
